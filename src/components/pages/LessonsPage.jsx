...
const LessonCard = ({ lesson, isSubscribed, onSubscribeRequest }) => {
  ...
  return (
    <>
      <div
        className={`lg-lesson-card group relative overflow-hidden ${isDark ? "lg-lesson-card-dark" : ""}`}
      ...
      >
        ...
        {/* Card Header */}
        <div
          className="relative h-48 overflow-hidden cursor-pointer rounded-t-[26px]"
    ...
    <div className="student-page student-lessons min-h-screen relative isolate overflow-x-hidden">
      <style>{`
        ...
        .lg-btn-primary {
          ...
          box-shadow: 0 1px 1px rgba(255,255,255,0.3) inset, 0 16px 40px rgba(99,102,241,0.35);
          border-radius: 16px;
          color: #fff;
          font-weight: 700;
          position: relative;
        ...
        .lg-btn-primary:hover {
          ...
          box-shadow: 0 1px 1px rgba(255,255,255,0.35) inset, 0 24px 50px rgba(99,102,241,0.45);
        }
        ...
        .lg-cta-button {
          ...
          color: #fff;
          font-weight: 700;
          box-shadow: 0 10px 28px rgba(99,102,241,0.4), 0 1px 0 rgba(255,255,255,0.3) inset;
        ...
        .lg-input::placeholder { color: #929aab; opacity: 1; }
        .lg-input:focus { 
