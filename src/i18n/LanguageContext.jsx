...
Object.assign(km, {
  ...
  "Sign In":"ចូលគណនី", "Sign in":"ចូលគណនី",
  "Recent Achievements":"សមិទ្ធផលថ្មីៗ", "learning":"ការសិក្សា", "Enrolled":"បានចុះឈ្មោះ",
  "Progress":"ដំណើរការ", "Certs":"វិញ្ញាបនបត្រ", "Students":"សិស្ស",
  "Welcome back":"ស្វាគមន៍ការត្រឡប់មកវិញ", "Sign in with your school account to continue.":"ចូលគណនីជាមួយគណនីសាលារបស់អ្នកដើម្បីបន្ត។",
  "or email":"ឬ អ៊ីមែល", "Email address":"អាសយដ្ឋានអ៊ីមែល", "Password":"ពាក្យសម្ងាត់",
  "Remember me":"ចងចាំខ្ញុំ", "Forgot password?":"ភ្លេចពាក្យសម្ងាត់?",
  "Student accounts are created by an administrator.":"គណនីសិស្សត្រូវបានបង្កើតដោយអ្នកគ្រប់គ្រង។",
  "Close login modal":"បិទផ្ទាំងចូលគណនី", "Continue your":"បន្ត", "journey.":"ដំណើរសិក្សារបស់អ្នក។",
  "Need an account?":"ត្រូវការគណនីមែនទេ?", "Create account →":"បង្កើតគណនី →",
  "Enter your credentials to continue":"បញ្ចូលព័ត៌មានសម្ងាត់របស់អ្នកដើម្បីបន្ត",
  "Signing in...":"កំពុងចូលគណនី...", "Your password":"ពាក្យសម្ងាត់របស់អ្នក",
  "Demo OTP:":"OTP គំរូ៖", "Change email or create another code":"ផ្លាស់ប្តូរអ៊ីមែល ឬបង្កើតលេខកូដផ្សេងទៀត",
  "At least 8 characters with a letter and number.":"យ៉ាងហោចណាស់ ៨ តួអក្សរ ដោយមានអក្សរ និងលេខ។",
  "Password updated":"បានធ្វើបច្ចុប្បន្នភាពពាក្យសម្ងាត់",
  "You can now sign in with your new password.":"ឥឡូវនេះអ្នកអាចចូលគណនីជាមួយពាក្យសម្ងាត់ថ្មីរបស់អ្នកបានហើយ។",
  "Back to sign in":"ត្រឡប់ទៅការចូលគណនី", "New password":"ពាក្យសម្ងាត់ថ្មី",
  "Confirm new password":"ផ្ទៀងផ្ទាត់ពាក្យសម្ងាត់ថ្មី",
  "Creating Digital":"ការបង្កើតស្នាដៃ",
  "GitHub Profile":"ប្រវត្តិរូប GitHub",
  "✦ Option 1":"✦ ជម្រើស ១", "✦ Option 2 — GPA > 3.5":"✦ ជម្រើស ២ — GPA > 3.5", "✦ Option 2 — GPA &gt; 3.5":"✦ ជម្រើស ២ — GPA > 3.5",
  "cr total":"ក្រេឌីតសរុប",
  "are free. Subscribe to unlock all.":"ឥតគិតថ្លៃ។ ជាវដើម្បីដោះសោទាំងអស់។",
  "Subscribe →":"ជាវ →", "Unlock All — $9.99/mo":"ដោះសោទាំងអស់ — $9.99/ខែ",
  "Video":"វីដេអូ", "Videos":"វីដេអូ",
  "Error 404":"កំហុស ៤០៤", "This page doesn’t exist":"មិនមានទំព័រនេះទេ",
  "The link may be outdated, or the page may have moved.":"តំណនេះអាចហួសសម័យ ឬទំព័រត្រូវបានផ្លាស់ទី។",
  "Go back":"ត្រឡប់ក្រោយ",
  "Loading your latest profile data...":"កំពុងផ្ទុកទិន្នន័យប្រវត្តិរូបចុងក្រោយរបស់អ្នក...",
  "Certificate earned":"ទទួលបានវិញ្ញាបនបត្រ", "Lesson available":"មានមេរៀនថ្មី",
  "Lesson enrolled":"បានចុះឈ្មោះរៀនមេរៀន",
  "Auto-Renewal":"ការបន្តស្វ័យប្រវត្តិ",
  "The quick brown fox jumps over the lazy dog":"អក្សរកម្ពុជា ភាសាខ្មែរ រៀបចំយ៉ាងស្អាត",
  "Username":"ឈ្មោះអ្នកប្រើ", "Theme":"រូបរាង",
  "Select Your Major":"ជ្រើសរើសជំនាញរបស់អ្នក",
  "Choose your department to customize your learning experience":"ជ្រើសរើសដេប៉ាតឺម៉ង់របស់អ្នកដើម្បីកែសម្រួលបទពិសោធន៍សិក្សា",
  "Continue":"បន្ត", "Select a major":"ជ្រើសរើសជំនាញ",
  "Please select a major to continue.":"សូមជ្រើសរើសជំនាញមួយដើម្បីបន្ត។",
  "Department of Information Technology Engineering":"ដេប៉ាតឺម៉ង់វិស្វកម្មបច្ចេកវិទ្យាព័ត៌មាន",
  "Department of Computer Science":"ដេប៉ាតឺម៉ង់វិទ្យាសាស្ត្រកុំព្យូទ័រ",
  "Department of Telecommunication":"ដេប៉ាតឺម៉ង់ទូរគមនាគមន៍",
  "Information Technology Engineering":"វិស្វកម្មបច្ចេកវិទ្យាព័ត៌មាន",
  "Computer Science":"វិទ្យាសាស្ត្រកុំព្យូទ័រ",
  "Telecommunication and Network":"ទូរគមនាគមន៍ និងបណ្ដាញ",
  "Ask me anything...":"សួរខ្ញុំបានគ្រប់យ៉ាង...",
  "Clear chat":"សម្អាតការសន្ទនា",
  "Open AI Chat":"បើកការសន្ទនា AI",
  "Scroll to top":"រំកិលទៅលើ",
});
...
const patterns = [
  ...
  [/^First (\d+) videos are free\. Subscribe to unlock all\.$/, (_, n) => `វីដេអូ ${n} ដំបូងឥតគិតថ្លៃ។ ជាវដើម្បីដោះសោទាំងអស់។`],
  [/^You need (\d+)% to pass\. Review the (.+) lessons, then try again when you are ready\.$/, (_, pass, major) => `អ្នកត្រូវតែបាន ${pass}% ដើម្បីជាប់។ សូមរំលឹកឡើងវិញនូវមេរៀន ${major} ហើយព្យាយាមម្ដងទៀតនៅពេលអ្នកត្រៀមខ្លួនរួចរាល់។`],
  [/^Please answer (\d+) required questions? before submitting\.$/, (_, n) => `សូមឆ្លើយ ${n} សំណួរចាំបាច់ មុនពេលបញ្ជូន។`],
...
const studentPath = /^\/(home|lessons|projects|calendar|profile|exam|settings|notifications|select-major|login)?(\/|$)/;
